...
<div class="receipt-main">
   ...
   <table class="col-8 table mt-3">
    <tr class="text-left">
        <p>&nbsp;&nbsp;&nbsp;Se realiza solicitud de material por el motivo  {{$objetivo}}.</p>
        <p>Luego de terminar el trabajo se hara entrega de este documento informando la cantidad total ocupada.</p>
    </tr>
